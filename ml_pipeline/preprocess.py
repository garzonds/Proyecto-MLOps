...
def seed_table_if_empty(table_name="forest_data"):
    ...
    try:
        ...
        if row_count == 0:
            ...
            print(f"Tabla {table_name} ya tiene {row_count} filas")

    except Exception:
        print(f"Tabla {table_name} no existe. Creándola desde CSV...")
        ...
        print(f"Tabla {table_name} creada con {len(df_csv)} filas")
...
def load_data(table_name="forest_data"):
    ...
    print(f"Datos cargados desde PostgreSQL: {df.shape}")
